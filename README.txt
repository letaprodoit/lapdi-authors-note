...
4. Default shortcode settings can be changed via `TSP Plugins`->`Authors Note` settings page
...
4. Author's Note widgets can be added to the sidemenu bar by visiting `Appearance > Widgets` and dragging the `TSP Authors Note` widget to your sidebar menu.
