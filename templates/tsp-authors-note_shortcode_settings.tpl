 <div class="tsp_container">
	...
	<div class="mycomment">
		...
		<div class="note-details">
			...
			<strong>[tsp-authors-note title="On After-Thought" show_name="Y" show_pic="Y" show_bio="Y" show_website="N" show_social_links="N" layout="0" thumb_size="80" before_title="" after_title=""]</strong>I was only 18 years old when I wrote this<strong>[/tsp-authors-note]</strong>
		</div>
